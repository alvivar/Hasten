...
public class Pool
{
	...
	// A pool with a Transform as prefab. The pool will grow if empty his
	// current size *= growFactor [0..1].
	...
	// Returns the Transform that represents the Pool parent. Used to store new
	// pool elements.
